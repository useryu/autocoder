...
import cn.agilecode.biz.service.PersonService;
...
public class CaffeineCacheController {
    ...
    @RequestMapping(value = "/testLoading", produces = "application/json")
	@ResponseBody
    ...
    @RequestMapping(value = "/testAsyncLoading", produces = "application/json")
	@ResponseBody
